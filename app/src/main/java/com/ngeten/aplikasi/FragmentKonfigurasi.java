 ...
 * Use the {@link FragmentKonfigurasi#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentKonfigurasi extends Fragment implements View.OnClickListener {
    TextView id_;
    EditText nama, no_hp, alamat, username, password, level;
    Button ubah, baru, keluar;
    String id, name, hp, almt, user, pass, lvl;
     ...
     * @return A new instance of fragment FragmentKonfigurasi.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentKonfigurasi newInstance(String param1, String param2) {
        FragmentKonfigurasi fragment = new FragmentKonfigurasi();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_konfigurasi,container,false);
        sessionManager = new SessionManager(getActivity());

        id_ = v.findViewById(R.id.id_user);
        ...
        baru = v.findViewById(R.id.insert);
    ...
    private void ubah(String id, String name, String hp, String almt, String user, String pass) {
        ...
        Call<Ubahkas> call = apiInterface.ubahKasRespon(id, name, hp, almt, user, pass);
        call.enqueue(new Callback<Ubahkas>() {
            @Override
            public void onResponse(Call<Ubahkas> call, Response<Ubahkas> response) {
                Toast.makeText(getActivity(), response.body().getMessage(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<Ubahkas> call, Throwable t) {
