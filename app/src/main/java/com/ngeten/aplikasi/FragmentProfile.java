...
public class FragmentProfile extends Fragment implements View.OnClickListener {
    ...
    Button ubah, keluar;
    String id, name, hp, almt, user, pass, level;
    ...
    private void ubah(String id, String name, String hp, String almt, String user, String pass) {
        ...
        Call<Ubah> ubahCall = apiInterface.ubahRespon(id, name, hp, almt, user, pass);
        ubahCall.enqueue(new Callback<Ubah>() {
            @Override
            public void onResponse(Call<Ubah> call, Response<Ubah> response) {
            ...
            @Override
            public void onFailure(Call<Ubah> call, Throwable t) {
